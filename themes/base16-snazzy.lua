...
-- Theme author: Chawye Hsu (https://github.com/h404bi) based on Hyper Snazzy Theme (https://github.com/sindresorhus/hyper-snazzy)
...
-- Base16 colors
property['color.base00'] = 0x362a28
property['color.base01'] = 0x3e3534
property['color.base02'] = 0x4f4543
property['color.base03'] = 0x7e7878
property['color.base04'] = 0xa9a5a5
property['color.base05'] = 0xe5e4e2
property['color.base06'] = 0xebf0ef
property['color.base07'] = 0xf0f1f1
property['color.base08'] = 0x575cff
property['color.base09'] = 0x439fff
property['color.base0A'] = 0x9df9f3
property['color.base0B'] = 0x8ef75a
property['color.base0C'] = 0xfeed9a
property['color.base0D'] = 0xffc757
property['color.base0E'] = 0xc16aff
property['color.base0F'] = 0x3c64b2
