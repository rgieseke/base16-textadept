...
colors.base08 = 0x7b7fff
colors.base09 = 0x70bfff
colors.base0A = 0x7cd6ff
colors.base0B = 0x78dabe
colors.base0C = 0xffd6be
colors.base0D = 0xe1be90
colors.base0E = 0xf7b3ef
colors.base0F = 0xb393ff
