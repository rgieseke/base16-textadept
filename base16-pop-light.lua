-- Pop theme for Textadept (http://foicica.com/textadept/)
...
property['color.base08'] = 0x8a00eb
property['color.base09'] = 0x3393f2
property['color.base0A'] = 0x12caf8
property['color.base0B'] = 0x49b337
property['color.base0C'] = 0xbbaa00
property['color.base0D'] = 0x945a0e
property['color.base0E'] = 0x8d1eb3
property['color.base0F'] = 0x002d7a
