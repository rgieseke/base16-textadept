-- Atelier Forest theme for Textadept (http://foicica.com/textadept/)
...
property['color.base0A'] = 0x1a91d5
property['color.base0B'] = 0x38b75a
property['color.base0C'] = 0x9cad00
