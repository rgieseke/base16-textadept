...
-- Tomorrow Night Blue theme for Textadept.
--
...
l.colors = {
  background   = color('00', '24', '51'),
  current_line = color('00', '34', '6e'),
  selection    = color('00', '3f', '8e'),
  foreground   = color('ff', 'ff', 'ff'),
  comment      = color('72', '85', 'b7'),
  red          = color('ff', '9d', 'a4'),
  orange       = color('ff', 'c5', '8f'),
  yellow       = color('ff', 'ee', 'ad'),
  green        = color('d1', 'f1', 'a9'),
  aqua         = color('99', 'ff', 'ff'),
  blue         = color('bb', 'da', 'ff'),
  purple       = color('eb', 'bb', 'ff'),
}
