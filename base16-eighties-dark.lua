...
property['color.base00'] = 0x2d2d2d
property['color.base01'] = 0x393939
property['color.base02'] = 0x515151
property['color.base03'] = 0x697374
property['color.base04'] = 0x939fa0
property['color.base05'] = 0xc8d0d3
property['color.base06'] = 0xdfe6e8
property['color.base07'] = 0xecf0f2
property['color.base08'] = 0x7a77f2
property['color.base09'] = 0x5791f9
property['color.base0A'] = 0x66ccff
property['color.base0B'] = 0x99cc99
property['color.base0C'] = 0xcccc66
property['color.base0D'] = 0xcc9966
property['color.base0E'] = 0xcc99cc
property['color.base0F'] = 0x537bd2
...
property['style.bracelight'] = 'fore:%(color.base01),back:%(color.base0C)'
...
buffer:set_fold_margin_hi_colour(true, property_int['color.base05'])
